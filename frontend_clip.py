...
# Function to find similar images based on text query
def find_similar_images_text(query):
    response = requests.post("http://localhost:5000/similar_images_text", json={"query": query})
